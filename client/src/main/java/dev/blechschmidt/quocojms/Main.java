...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        MessageBrokerSettings settings = new MessageBrokerSettings(args);
        ...
        Queue queue = session.createQueue(Constants.QUEUE_CLIENT_REQ);
        Topic topic = session.createTopic(Constants.TOPIC_CLIENT_RES);
        ...
        for (ClientInfo info : clients) {
            ...
            // production).
            QuotationRequestMessage quotationRequest = new QuotationRequestMessage(info.hashCode(), info);
    ...
    public static void displayProfile(ClientInfo info) {
        ...
        System.out.println(
                "| Name: " + String.format("%1$-29s", info.name) +
                        " | Gender: "
                        + String.format("%1$-27s",
                                (info.gender == ClientInfo.MALE ? "Male" : "Female"))
                        +
    ...
    public static void displayQuotation(Quotation quotation) {
        System.out.println(
                "| Company: " + String.format("%1$-26s", quotation.company) +
                        ...
                        " | Price: "
                        + String.format("%1$-28s", NumberFormat.getCurrencyInstance()
                                .format(quotation.price))
                        + " |");
        System.out.println(
                "|=================================================================================================================|");
    }
